...
Retrieves spectral light sensor readings from one or more BirdWeather
PUC stations. Includes 8 spectral channels (f1-f8), clear light, and
...
A data.table with columns: station_id, timestamp, clear, nir, f1, f2,
f3, f4, f5, f6, f7, f8
